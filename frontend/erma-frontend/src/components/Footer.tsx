const Footer = () => {
  return (
    <footer className="bg-slate-800 text-white py-2 sm:py-3 mt-auto">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 text-center">
        ...
        <p className="text-slate-300 mb-2 sm:mb-3 text-xs sm:text-sm">
        ...
        <div className="flex justify-center items-center gap-2 sm:gap-3">
          ...
          <a
            href="#"
            className="text-slate-300 hover:text-white transition-colors p-1 sm:p-1.5 rounded-full hover:bg-slate-700"
          >
            <svg
